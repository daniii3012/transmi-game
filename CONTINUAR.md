...
54 pruebas Node y 3 Python pasaron. Benchmarks con semáforos y las tres rutas reimportadas: referencia 1.093 buses máximos muestreados, 70 esperando atención y 116 en semáforo; preparación 8,57 s, muestreo 0,81 ms, heap 526 MB. Estrés 2/3 min y demanda 3×: 3.252 buses, 1.455 esperando atención y 223 en semáforo; 16,40 s / 4,19 ms / 1.114 MB. Máximos exactos por eventos 1.100/3.255. CPU Node, no FPS; el estrés puede congestionarse, sin borrar vehículos.
