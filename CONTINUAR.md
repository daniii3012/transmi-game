...
Procedimiento de actualización de fuentes en docs/ACTUALIZAR_DATOS.md; es el documento a seguir cuando cambie el sistema real. Revisión de los 23 pendientes con evidencia consultada de nuevo en docs/PENDIENTES_20260911.md: E48/12444 y H76/1213 ya tienen trazado publicado y K86/629 devuelve 1.294 coordenadas frente a 108 en la instantánea; activarlos exige instantánea nueva y decisión de curación, así que siguen pendientes. El contexto urbano es la única fuente sin `fetch_*` y con la ruta fija dentro de build_context.py.
