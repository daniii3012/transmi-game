...
55 pruebas Node y 3 Python pasaron. Benchmarks con semáforos de calzada y de calle: referencia 1.114 buses máximos muestreados, 73 esperando atención y 124 en semáforo; preparación 8,27 s, muestreo 0,60 ms, heap 530 MB. Estrés 2/3 min y demanda 3×: 3.338 buses, 1.475 esperando atención y 231 en semáforo; 18,18 s / 3,95 ms / 1.136 MB. Máximos exactos por eventos 1.124/3.362. CPU Node, no FPS; el estrés puede congestionarse, sin borrar vehículos.
