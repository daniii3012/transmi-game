import {mountShell} from './shell.mjs?v=20260913.1';
import {NetworkMap} from './map.mjs?v=20260913.1';
import {DAY,addDays,dayType,dateNumber,dateEligible,validityState,serviceWindows,demandPeriod} from './calendar.mjs?v=20260913.1';
import {DEFAULTS,parameters} from './operation.mjs?v=20260913.1';
import {registerSimulationTools} from './webmcp.mjs?v=20260913.1';
import {LiveFeed,groupByDestination,occupancyText,ageText,sameName} from './live.mjs?v=20260913.1';
...
try{
 ...
 let worker=new Worker('./worker.mjs?v=20260913.1',{type:'module'});
