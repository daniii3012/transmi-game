import {mountShell} from './shell.mjs?v=20260912.18';
import {NetworkMap} from './map.mjs?v=20260912.18';
import {DAY,addDays,dayType,dateNumber,dateEligible,validityState,serviceWindows,demandPeriod} from './calendar.mjs?v=20260912.18';
import {DEFAULTS,parameters} from './operation.mjs?v=20260912.18';
import {registerSimulationTools} from './webmcp.mjs?v=20260912.18';
import {LiveFeed,groupByDestination,occupancyText,ageText,sameName} from './live.mjs?v=20260912.18';
...
try{
 ...
 let worker=new Worker('./worker.mjs?v=20260912.18',{type:'module'});
