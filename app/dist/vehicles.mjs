 ...
 *
 * El alimentador oficial publica la etiqueta de flota de cada vehículo y esa etiqueta separa
...
const ORIGEN={published:'Tipo publicado',observed:'Flota observada en el alimentador oficial',
...
export function vehicleSpec(route,params={},seed=0){
 ...
 if(base){
  const buses=perfil.buses?` · ${perfil.buses} buses el ${perfil.snapshot}`:'';
